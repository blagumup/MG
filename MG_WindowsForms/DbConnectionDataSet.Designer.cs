...
namespace MG_WindowsForms {
    ...
    public partial class DbConnectionDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Id, string UPC, string Name, string Category, double Height, double Width, double Depth, decimal Cost, decimal Price) {
            ...
            public string UPC {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'UPC\' в таблице \'Products\' равно DBNull.", e);
                    }
                }
                set {
...
namespace MG_WindowsForms.DbConnectionDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ([Height] = @Origin" +
                "al_Height) AND ([Width] = @Original_Width) AND ([Depth] = @Original_Depth) AND (" +
                "[Cost] = @Original_Cost) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([Id], [UPC], [Name], [Category], [Height], [Width], [Depth], [Cost], [Price]) VALUES (@Id, @UPC, @Name, @Category, @Height, @Width, @Depth, @Cost, @Price);
SELECT Id, UPC, Name, Category, Height, Width, Depth, Cost, Price FROM Products WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Id] = @Id, [UPC] = @UPC, [Name] = @Name, [Category] = @Category, [Height] = @Height, [Width] = @Width, [Depth] = @Depth, [Cost] = @Cost, [Price] = @Price WHERE (([Id] = @Original_Id) AND ([Height] = @Original_Height) AND ([Width] = @Original_Width) AND ([Depth] = @Original_Depth) AND ([Cost] = @Original_Cost) AND ([Price] = @Original_Price));
SELECT Id, UPC, Name, Category, Height, Width, Depth, Cost, Price FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MG_WindowsForms.Properties.Settings.Default.DbConnectionConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UPC, Name, Category, Height, Width, Depth, Cost, Price FROM dbo.Produc" +
                "ts";
        ...
        public virtual int Fill(DbConnectionDataSet.ProductsDataTable dataTable) {
        ...
        public virtual DbConnectionDataSet.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbConnectionDataSet.ProductsDataTable dataTable = new DbConnectionDataSet.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DbConnectionDataSet.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Id, double Original_Height, double Original_Width, double Original_Depth, decimal Original_Cost, decimal Original_Price) {
            if ((Original_Id == null)) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((double)(Original_Depth));
        ...
        public virtual int Insert(string Id, string UPC, string Name, string Category, double Height, double Width, double Depth, decimal Cost, decimal Price) {
            if ((Id == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[6].Value = ((double)(Depth));
        ...
        public virtual int Update(string Id, string UPC, string Name, string Category, double Height, double Width, double Depth, decimal Cost, decimal Price, string Original_Id, double Original_Height, double Original_Width, double Original_Depth, decimal Original_Cost, decimal Original_Price) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((double)(Depth));
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((double)(Original_Width));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UPC, string Name, string Category, double Height, double Width, double Depth, decimal Cost, decimal Price, string Original_Id, double Original_Height, double Original_Width, double Original_Depth, decimal Original_Cost, decimal Original_Price) {
            return this.Update(Original_Id, UPC, Name, Category, Height, Width, Depth, Cost, Price, Original_Id, Original_Height, Original_Width, Original_Depth, Original_Cost, Original_Price);
        }
    }
